plugins {
    ...
    id("kotlin-kapt")
    // 👇 1. THÊM DÒNG NÀY (Bắt buộc cho Kotlin 2.0)
...
android {
    ...
    // 👇 2. SỬA KHỐI NÀY (Xóa dòng kotlinCompilerExtensionVersion)
    composeOptions {
        // Dòng dưới đây đã bị xóa vì không còn dùng trong Kotlin 2.0 nữa
